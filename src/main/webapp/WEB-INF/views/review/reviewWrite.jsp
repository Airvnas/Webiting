  ...
  <input type="hidden" name="pnum_fk" value="${pnum}">
   <!-- 원본글쓰기mode는 write, 답변글쓰기 mode는 rewrite로 감  -->       
    <table class="table">
       ...
       <tr>
          <td style="width:50%">
          <input type="text" name="revwriter" id="revwriter" placeholder="작성자" class="form-control">
          </td>
          <td style="width:50%"></td>
       </tr>
       <tr>
       ...
       <tr>
          <td colspan="2">
          <textarea name="content" id="content" placeholder="문의내용" rows="10" cols="50" class="form-control">
          </textarea>
